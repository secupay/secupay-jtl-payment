...
/**
 * Class agws_secupay_flex_ls
 */
class agws_secupay_flex_ls extends PaymentMethod
{
    /**
    ...
    public function init($nAgainCheckout = 0)
    {
        ...
        $this->name    = 'agws-secupay-ls';
        $this->caption = 'agws-secupay-ls';
    }
    /**
    ...
    public function preparePaymentProcess($order)
    {
        ...
        if ($agws_secupay_flex_antwort_json->status == "ok" && isset($agws_secupay_flex_antwort_json->data->iframe_url)
            ...
            if ($agws_secupay_flex_antwort_json->status == "ok" && isset($agws_secupay_flex_antwort_json->data->hash)
                ...
                header(
                    "location: bestellvorgang.php?editZahlungsart=1&AGWS_SECUPAY_ZA=LS&AGWS_SECUPAY_ERRORCODE="
    ...
    public function agws_secupay_flex_getCurlContent($agws_linkaction, $agws_httpheader, $agws_data = null)
    {
        ...
        if (function_exists('curl_init')) {
            ...
            $agws_secupay_flex_logtext = 'secupay_flex - LS - function getCurlContent <br />
    ...
    {
        $agws_secupay_flex_logtext = 'secupay_flex - LS - function ' . $agws_function . ' <br />' . $agws_logbase . '-'
            . $agws_logstatus . ' <br />
    ...
    public function handleNotification($order, $agws_secupay_flex_paymentHash, $args)
    {
        ...
        if (isset($_REQUEST['sh']) && isset($_REQUEST['agws_sp_url']) && $_REQUEST['agws_sp_url'] == 'push') {
            ...
            if ($this->verifyNotification(
                ...
                if ($this->oPlugin->oPluginEinstellungAssoc_arr[$this->cModulId . "_agws_secupay_flex_ls_comment"]
                    == 2) {
                    $this->secupayHelper->isShop4()
                        ? Shop::DB()
                              ->executeQuery(
                ...
                $agws_secupay_flex_logtext = 'secupay_flex - LS - function handleNotification <br />
        ...
        switch ($_REQUEST['agws_sp_url']) {
            case "succ":
                ...
                if ($status == true
                    ...
                    $agws_secupay_flex_logtext = 'secupay_flex - LS - function verifyNotification <br />
