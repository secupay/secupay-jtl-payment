...
class agws_secupay_flex_pp extends PaymentMethod
{
    ...
    public function preparePaymentProcess($order)
    {
        ...
        if ($agws_secupay_flex_antwort_json->status == "ok" && isset($agws_secupay_flex_antwort_json->data->iframe_url)
            ...
            if ($agws_secupay_flex_antwort_json->status == "ok" && isset($agws_secupay_flex_antwort_json->data->hash)
                ...
                header(
                    "location: bestellvorgang.php?editZahlungsart=1&AGWS_SECUPAY_ZA=PP&AGWS_SECUPAY_ERRORCODE="
    ...
    public function agws_secupay_flex_getCurlContent($agws_linkaction, $agws_httpheader, $agws_data = null)
    {
        ...
        if (function_exists('curl_init')) {
            ...
            $agws_secupay_flex_logtext = 'secupay_flex - PP - function getCurlContent <br />
    ...
    {
        $agws_secupay_flex_logtext = 'secupay_flex - PP - function ' . $agws_function . ' <br />' . $agws_logbase . '-'
            . $agws_logstatus . ' <br />
    ...
    public function handleNotification($order, $agws_secupay_flex_paymentHash, $args)
    {
        ...
        if (isset($_REQUEST['sh']) && isset($_REQUEST['agws_sp_url']) && $_REQUEST['agws_sp_url'] == 'push') {
            ...
            if ($this->verifyNotification(
                ...
                . "_agws_secupay_flex_pp_due_design"]) {
                    case 0:
                    ...
                    case 1:
                        ...
                        $agws_secupay_flex_pp_due_days = $this->oPlugin->oPluginEinstellungAssoc_arr[$this->cModulId
                        . "_agws_secupay_flex_due_days_pp"];
                        $agws_secupay_flex_pp_due_text = str_replace(
                            '|t|',
                            $agws_secupay_flex_pp_due_days,
                            $agws_secupay_flex_pp_due_text
                        );
                        break;
                ...
                $smarty->assign(
                    ...
                    utf8_decode($agws_secupay_flex_antwort_json->data->opt->transfer_payment_data->bankname)
                );
                $smarty->assign(
                ...
                $smarty->assign(
                    'agws_secupay_flex_pp_due_design',
                    $this->oPlugin->oPluginEinstellungAssoc_arr[$this->cModulId . "_agws_secupay_flex_pp_due_design"]
                );
                $smarty->assign('agws_secupay_flex_pp_due_text', utf8_encode($agws_secupay_flex_pp_due_text));
                ...
                $smarty->assign(
                    'agws_secupay_flex_bank_recipient_legal',
                    utf8_decode($agws_secupay_flex_antwort_json->data->opt->recipient_legal)
                );
                $smarty->assign(
                ...
                if ($this->oPlugin->oPluginEinstellungAssoc_arr[$this->cModulId . "_agws_secupay_flex_pp_comment"]
                    == 2) {
                    $this->secupayHelper->isShop4()
                        ? Shop::DB()
                              ->executeQuery(
                ...
                $agws_secupay_flex_logtext = 'secupay_flex - PP - function handleNotification <br />
        ...
        switch ($_REQUEST['agws_sp_url']) {
            case "succ":
                ...
                if ($status == true
                    ...
                    $agws_secupay_flex_logtext = 'secupay_flex - PP - function verifyNotification <br />
